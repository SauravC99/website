...
import radix30 from "./Radix30.gif";
import tim50 from "./Tim50.gif";
...
<Image src={radix30} alt="radix sort" loading="eager" decoding="sync" />
...
<Image src={tim50} alt="tim sort" loading="eager" decoding="sync" />
